...
/*  Power Domain just configuration for SM8475,
 *  Table need refer to sm8475 clock_plan datasheet.
 */
static unsigned int sm8475_cluster_pd[MAX_CLUSTER] = {14, 20, 21};
static unsigned int sm8475_pd_sliver[14] = {
	0,/* LowSVS */
	0,/* LowSVS */
	0,/* LowSVS */
	1,/* SVS */
...
static unsigned int sm8475_pd_golden[20] = {
	0,/* LowSVS */
	1,/* SVS */
	1,/* SVS */
	2,/* SVS_L1 */
...
static unsigned int sm8475_pd_goplus[21] = {
	0,/* LowSVS */
	1,/* SVS */
	1,/* SVS */
	2,/* SVS_L1 */
