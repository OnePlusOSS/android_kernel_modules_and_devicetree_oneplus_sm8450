...
#define CAM_OEM_GET_SENSOR_THERMAL_DATA         (CAM_OEM_COMMON_OPCODE_BASE + 0xF)
...
#define VIDIOC_OIS_INIT_IN_ADVANCE 0x9003
#define CAM_OEM_ACTUATOR_SETFOCUS (VIDIOC_CAM_SENSOR_STATR + 0x2)
#define CAM_OEM_ACTUATOR_GET_ID   (VIDIOC_CAM_SENSOR_STATR + 0x3)
#define CAM_OEM_ACTUATOR_STATR    (VIDIOC_CAM_SENSOR_STATR + 0x4)
#define CAM_OEM_ACTUATOR_STOP     (VIDIOC_CAM_SENSOR_STATR + 0x5)
