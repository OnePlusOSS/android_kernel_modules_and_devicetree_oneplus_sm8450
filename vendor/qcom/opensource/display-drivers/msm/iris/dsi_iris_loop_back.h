...
enum LOOP_BACK_ERR_TYPE {
	...
	ERR_DUAL_PT			= 2,
	ERR_DTG_MEASURE		= 3,
	ERR_DTG_MEASURE_58	= 4,
	ERR_SRAM_BIST_5A	= 5,
	ERR_SRAM_BIST_A5	= 6,
	ERR_EFIFO_LOOP_BACK	= 7,
	ERR_EMA4_LOOP_BACK  = 8,
	ERR_I2C				= 9,
	ERR_ATSPEED_EFIFO 	= 10,
	ERR_SMT_PMU		= 11,
};
...
#define BIT_I2C             (1 << 8)
#define BIT_ATSPEED_EFIFO	(1 << 9)
#define BIT_SMT_PMU			(1 << 10)

int32_t iris_parse_loopback_info(struct device_node *np);
